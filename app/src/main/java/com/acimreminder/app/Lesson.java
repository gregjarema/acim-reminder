...
/**
 * The single hardcoded lesson for v1: A Course in Miracles, Workbook Lesson 99.
 *
 * Later (v2) this becomes one entry in a multi-lesson list, but for now it is
 * a plain holder so everything else can be built and tested against real text.
 */
public final class Lesson {

    /** Shown as the screen/notification heading. */
    public static final String TITLE = "Lesson 99";
